...
const find_patients_timelines_service_1 = require("./find-patients-timelines.service");
describe("Testing find patient's timelines service", () => {
    afterEach(() => {
        jest.resetAllMocks();
    });
    it("Should get all timelines of a patient", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const response = yield (0, find_patients_timelines_service_1.findPatientsTimelinesservice)("64acbc1c65374d8907391968");
